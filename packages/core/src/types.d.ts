...
export type ComputePosition = (reference: unknown, floating: unknown, config: ComputePositionConfig) => ComputePositionReturn;
...
export { type Options as DetectOverflowOptions, detectOverflow, } from './detectOverflow';
export { type ArrowOptions, arrow } from './middleware/arrow';
export { type AutoPlacementOptions, autoPlacement, } from './middleware/autoPlacement';
