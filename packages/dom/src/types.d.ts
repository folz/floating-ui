...
export interface Platform {
    ...
    getOffsetParent?: (element: Element, polyfill?: (element: HTMLElement) => Element | null) => Element | Window;
 ...
 */
declare const detectOverflow: (state: MiddlewareState, options?: DetectOverflowOptions) => SideObject;
